...
# prints true but useless information about him/her

name = input("Hi. What's your name? ")

age = int(input("How old are you? "))

weight = int(input("Okay, last question. How many much do you weigh in pounds? "))

print("\nIf poet ee cummings were to email you, he'd address you as", name.lower())
print("But if ee cummings were made, he'd call you", name.upper())
...
print("On the sun, you'd weigh", sun_weight, "(but, not for long)...")
